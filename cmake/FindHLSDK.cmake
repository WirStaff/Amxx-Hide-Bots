...
find_path(HLSDK_COMMON_INCLUDE_DIR
        NAMES cl_entity.h
        PATHS ${AMXX_HIDE_BOTS_ROOT}/dep/halflife/common
        NO_DEFAULT_PATH
        NO_CACHE
)
...
find_path(HLSDK_DLLS_INCLUDE_DIR
        NAMES client.h
        PATHS ${AMXX_HIDE_BOTS_ROOT}/dep/halflife/dlls
        NO_DEFAULT_PATH
        NO_CACHE
)
...
find_path(HLSDK_ENGINE_INCLUDE_DIR
        NAMES APIProxy.h
        PATHS ${AMXX_HIDE_BOTS_ROOT}/dep/halflife/engine
        NO_DEFAULT_PATH
        NO_CACHE
)
...
find_path(HLSDK_PUBLIC_INCLUDE_DIR
        ...
        PATHS ${AMXX_HIDE_BOTS_ROOT}/dep/halflife/public
        NO_DEFAULT_PATH
        NO_CACHE
)
